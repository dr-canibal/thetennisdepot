...
<head>
	...
	var lz_chat_rate_settings = Array(0,0);
	...
	function ValidateRating()
	{
		if(lz_chat_rate_settings[0] == 0 || lz_chat_rate_settings[1] == 0)
			return top.lz_chat_chat_alert(top.lz_chat_data.Language.SelectRating,top.frames['lz_chat_frame.3.2'].frames['lz_chat_frame.3.2.chat.4.0']);
			
		if(!lz_chat_rate_comment_started)
			document.getElementById("lz_chat_rate_comment").value = "";
			
		if(document.getElementById("lz_chat_rate_comment").value.length > 400)
			return top.lz_chat_chat_alert(top.lz_chat_data.Language.MessageTooLong + " (-" + (document.getElementById("lz_chat_rate_comment").value.length-400).toString() + ")",top.frames['lz_chat_frame.3.2'].frames['lz_chat_frame.3.2.chat.4.0']);
