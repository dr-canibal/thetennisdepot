		...
		<tr>
			<td align="center" valign="top">	
				<table cellpadding="5" cellspacing="3">
					<tr>
						<tr>
							<td class="lz_chat_form_field" width="150"><strong><!--lang_client_your_name-->:</strong></td><td width="220"><input id="lz_chat_mail_name" class="lz_chat_mail_box" value="<!--login_value_name-->" maxlength="32"></td>
						</tr>
						<tr>
							<td class="lz_chat_form_field"><strong><!--lang_client_your_email-->:</strong></td><td><input id="lz_chat_mail_email" class="lz_chat_mail_box" value="<!--login_value_email-->" maxlength="50"></td>
						</tr>
						<tr>
							<td class="lz_chat_form_field"><!--lang_client_your_company-->:</td><td><input id="lz_chat_mail_company" class="lz_chat_mail_box" value="<!--login_value_company-->" maxlength="50"></td>
						</tr>
						<tr>
							<td class="lz_chat_form_field"><!--lang_client_your_message-->:</td><td valign="top"><textarea id="lz_chat_mail_message" class="lz_chat_mail_box"></textarea></td>
						</tr>
						<tr>
