...
$LZLANG["client_ints_are_busy"] = "ขณะนี้เจ้าหน้าที่กำลังให้บริการลูกค้าท่านอื่นอยู่, กรุณารอสักครู่...";
$LZLANG["client_int_left"] = "ขณะนี้เจ้าหน้าที่ออกจากระบบสนทนาแล้ว. หากท่านมีคำถามเพิ่เติมกรุณาฝากข้อความทิ้งไว้:";
...
$LZLANG["client_leave_message_short"] = "ฝากข้อความ";
...
$LZLANG["index_write_access"] = "เขียนไฟล์ได้";
$LZLANG["index_no_write_access"] = "ไม่สามารถเขียนไฟล์ได้";
$LZLANG["index_phpversion_needed"] = "ต้องเป็นเวอร์ชั่น <!--version--> หรือ สูงกว่า";
$LZLANG["index_solve"] = "เรียนรู้วิธีแก้ไขปัญหานี้ ..";
$LZLANG["index_adding_server"] = "เพิ่ม LiveZilla Server โปรไฟล์ นี้";
$LZLANG["index_adding_server_hint"] = "ต้องการติดตั้ง LiveZilla ในเครื่องของท่าน";
$LZLANG["index_close"] = "ปิด";
$LZLANG["index_not_available"] = "ไม่สามารถให้บริการได้";
$LZLANG["index_addserver"] = "เพิ่ม server";
$LZLANG["index_description_install"] = "ท่านสามารถติดตั้ง LiveZilla โดยตรงจาก server นี้. หลังจากทำการ download และ ติดตั้งโปรแกรมเรียบร้อยแล้ว ท่านจะสามารถทำการเชื่อมต่อกับ LiveZilla Server หรือ สร้าง LiveZilla Server ของท่านเองได้";
$LZLANG["index_description_profile"] = "ท่านสามารถ download ข้อมูลโปรไฟล์ของ LiveZilla จาก Server เครื่องนี้ เพียงแค่คลิกเดียว. LiveZilla Server โปรไฟล์ ประกอบด้วยข้อมูลที่จำเป็นสำหรับการเชื่อมต่อกับ server.";
