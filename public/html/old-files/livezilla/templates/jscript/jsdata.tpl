function lz_chat_data()
{
	...
	this.INTERNAL = 0;
	this.EXTERNAL = 1;
	this.MAXCHATLENGTH = 750;
	this.STATUS_STOPPED = 3;
	...
	{
		this.NameAndEmail = "<!--lang_client_please_enter_name_and_email-->";
		...
		this.ClientIntsAreBusy = "<!--lang_client_ints_are_busy-->";
	...
	{
		this.Id = '';
		this.Username = '<!--login_value_name-->';
		this.Email = '<!--login_value_email-->';
		this.Company = '<!--login_value_company-->';
		this.MailText = '';
		this.Group = '';
		this.Typing = false;
		this.Messages = Array();
		this.MessagesBackup = Array();
		this.Session;
	}
