 ...
 */
class TBT_Rewards_Manage_MigrationController extends Mage_Core_Controller_Front_Action
{
    ...
    public function migrateAction()
    {
     ...
     private function createTransfer($cust_email, $num_points){
    	...
    	$cust = Mage::getModel('rewards/customer')
    			->setWebsiteId($this->site_id)
    			->loadByEmail($cust_email);
    	if(!$cust){
    		...
    		$transfer->setId(null)
    				...
    				->setCustomerId($cust->getId())
    				->setCurrencyId(1)
    				->setQuantity(round($num_points))
    				->setStatus(5)
