...
class TBT_Rewards_Block_Manage_Transfer_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
	protected function _prepareForm()
	{
        ...
        if(!isset($formData['status'])) $formData['status'] = null;
        ...
        $fieldset->addField('currency_id', 'select', array(
            'label'     => Mage::helper('rewards')->__('Points Currency'),
            'title'     => Mage::helper('rewards')->__('Points Currency'),
            'name'      => 'currency_id',
            'required' => true,
        ...
        $fieldset->addField('transfer_style', 'select', array(
            'label'     => Mage::helper('rewards')->__('Transfer Style'),
            'title'     => Mage::helper('rewards')->__('Transfer Style'),
            'name'      => 'transfer_style',
            'required' => true,
            'class'     => 'required-entry',
            'options'    => array(
            	'give'	 =>	Mage::helper('rewards')->__('Give Points'),
        ...
        $fieldset->addField('reason_id', 'select', array(
            ...
            'class'     => 'required-entry',
            'required' => true,
            'options'    => $availReasons,
        ));
	  		
		$fieldset->addField('comments', 'editor', array(
            'name'      => 'comments',
            'label'     => Mage::helper('rewards')->__('Comments/Notes'),
