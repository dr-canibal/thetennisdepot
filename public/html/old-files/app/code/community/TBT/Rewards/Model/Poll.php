    	...
    	if(Mage::getModel('customer/session')->getCustomerId()){
            ...
            if(!$hasRecievedPoints){
		        foreach($ruleCollection as $rule){
		        	...
		        	try {
			        	//Create the transfer
			            $is_transfer_successful = Mage::helper('rewards/transfer')->transferPollPoints(
		        	...
		        	if ($is_transfer_successful) {
			            ...
			            Mage::getSingleton('core/session')->addSuccess(Mage::helper('rewards')->__('You received %s for voting',
