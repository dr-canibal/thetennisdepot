...
class TBT_Rewards_Block_Manage_Transfer_Distribution extends TBT_Rewards_Block_Manage_Transfer
{
	public function __construct()
	{
		...
		$this->setTemplate('rewards/transfer/distribution.phtml');
	}

    protected function _prepareLayout()
    {
        $this->setChild('grid', $this->getLayout()->createBlock('blog/manage_transfer_distribution_grid', 'distribution.grid'));
