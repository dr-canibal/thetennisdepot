...
class TBT_Rewards_Block_Manage_Promo_Catalog_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    public function __construct()
    {
        ...
        if($this->_isRedemptionType()) {
        	$this->setTitle(Mage::helper('catalogrule')->__('Catalog Points Redemption Rule'));
        } else {
        	$this->setTitle(Mage::helper('catalogrule')->__('Catalog Points Distribution Rule'));
        }
    }
    ...
    protected function _beforeToHtml()
    {
        $this->addTab('main_section', array(
            ...
            'content'   => $this->getLayout()->createBlock('rewards/manage_promo_catalog_edit_tab_main')->toHtml(),
            'active'    => true
        ));
        ...
        $this->addTab('conditions_section', array(
            ...
            'content'   => $this->getLayout()->createBlock('rewards/manage_promo_catalog_edit_tab_conditions')->toHtml(),
        ));

        $this->addTab('actions_section', array(
            'label'     => Mage::helper('catalogrule')->__('Actions'),
            'title'     => Mage::helper('catalogrule')->__('Actions'),
            'content'   => $this->getLayout()->createBlock('rewards/manage_promo_catalog_edit_tab_actions')->toHtml(),
        ));
