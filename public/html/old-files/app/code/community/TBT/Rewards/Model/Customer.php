...
class TBT_Rewards_Model_Customer extends Mage_Customer_Model_Customer
{
    ...
    private function createTransferForNewCustomer(){
        ...
        foreach($ruleCollection as $rule){
        	...
        	if ($is_transfer_successful) {
	            ...
	            Mage::getSingleton('core/session')->addSuccess(Mage::helper('rewards')->__('You received %s for signing up!',
	 ...
	 * @return array
	 */
	private function _getPointSums($status) {
		if ($status=='*active*') {
...
//			}
	 ...
	 * @return boolean
	 */
	public function hasPointsForNewsletter($newsletter_id) {
		$hasReceivedPoints = !$this->getNewsletterTransfers($newsletter_id)->sumPoints()->isNoPoints();
