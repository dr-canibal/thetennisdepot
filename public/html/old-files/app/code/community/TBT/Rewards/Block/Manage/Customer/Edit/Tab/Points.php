 ...
 */
class TBT_Rewards_Block_Manage_Customer_Edit_Tab_Points
...
//        $this->addExportType('*/*/exportXml', Mage::helper('customer')->__('XML'));
    ...
    protected function _prepareLayout() {
    	$url = $this->getUrl('rewards/manage_transfer/new', array( 
    					'module' => 'adminhtml', 
    					'controller' => 'customer', 
    					'action' => 'edit',
...
//						'url'       => array('base'=> 'rewards/manage_transfer/edit'),
						'url' => array('base'=> 'rewards/manage_transfer/edit/'.
									'module/adminhtml/controller/customer/action/edit/'.
									'customer_id/'. $this->getCustomer()->getId()),
						'field'     => 'id'
					)
				),
    ...
    {
        return $this->getUrl(
        	'rewards/manage_customer_edit/transfersGrid', 
        	array(
