...
class TBT_Rewards_Block_Manage_Transfer_Edit_Tab_Grid_Polls extends Mage_Adminhtml_Block_Widget_Grid
{
        ...
        $this->setChild('clear_selections_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData(array(
                    ...
                    'onclick'   => 'clearGridSelections(\'poll_id\')',
                ))
        );
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('assigned_polls', array(
            'header_css_class' => 'a-center',
            'header'    => Mage::helper('adminhtml')->__('Origin'),
            'type'      => 'radio',
            'html_name' => 'poll_id',
            'values'    => $this->_getSelectedPolls(),
            'align'     => 'center',
            'index'     => 'poll_id',
        	'filter_index' => 'poll_id',
        ));
			...
			array(
				...
				'actions'   => array(
					array(
						...
						'url'       => array('base'=> 'adminhtml/poll/edit/tab/answers_section'),
						'field'     => 'id'
					)
				),
				'filter'    => false,
