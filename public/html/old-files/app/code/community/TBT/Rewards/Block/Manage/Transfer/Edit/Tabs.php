...
class TBT_Rewards_Block_Manage_Transfer_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml()
    {
        ...
        if($transfer->isOrder()) {
	        if (Mage::getSingleton('admin/session')->isAllowed('sales/order/actions/view')) {
	            $this->addTab('orders_section', array(
	                ...
	                'content'   => $this->getLayout()->createBlock('rewards/manage_transfer_edit_tab_grid_orders')->toHtml(),
	            ));
	        }
        }
        if($transfer->isPoll()) {
            $this->addTab('polls_section', array(
        ...
        if($transfer->isFriendTransfer()) {
            $this->addTab('friends_section', array(
        ...
        if($transfer->isReview()) {
            $this->addTab('reviews_section', array(
