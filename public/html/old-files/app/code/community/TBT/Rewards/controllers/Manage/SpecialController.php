 ...
 */
class TBT_Rewards_Manage_SpecialController extends Mage_Adminhtml_Controller_action
{
    ...
    {
        $this->loadLayout()
            ->_setActiveMenu('rewards/rules/special');
        return $this;
    }
    ...
    public function editAction()
    {
        ...
        $this->getLayout()->getBlock('head')
            ...
            ->setCanLoadRulesJs(true); // TODO: remove this line;
		
        $breadcrumb = $id ? Mage::helper('rewards')->__('Edit Rule') : Mage::helper('rewards')->__('New Rule');
        $this
            ->_addBreadcrumb($breadcrumb, $breadcrumb) // (label, title)
            ->_addContent($block)
            ->_addLeft($this->getLayout()->createBlock('rewards/manage_special_edit_tabs'))
            ->renderLayout();
    ...
    public function gridAction()
    {
        ...
        $this->getResponse()->setBody(
            $this->getLayout()->createBlock('rewards/manage_special_edit_tab_product')->toHtml()
        );
    }
        ...
        if ($data = $this->getRequest()->getPost()) {
            ...
            try {
            	...
            	if ($back = $this->getRequest()->getParam('back')) { 
                	$this->_forward('edit', 'manage_special', 'rewards', array('id' => $model->getId()));
            	} else {
