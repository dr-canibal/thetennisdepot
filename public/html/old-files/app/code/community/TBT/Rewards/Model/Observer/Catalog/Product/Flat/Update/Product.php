...
class TBT_Rewards_Model_Observer_Catalog_Product_Flat_Update_Product
{
	...
	public function updateCatalogRulesHash($observer)
	{
        ...
        foreach ($collection as $row) {
			...
			$associated_rule_ids = $this->_getAssociatedRules($product_id);
	 ...
	 * @return array()
	 */
	protected function _getAssociatedRules($product_id) {
		if ( isset($this->associated_rule_ids_by_product[$product_id]) ) {
		    ...
		    $associated_rule_ids = Mage::helper('rewards/transfer')
                ->getCatalogRewardsRuleIdsForProduct($product_id);
