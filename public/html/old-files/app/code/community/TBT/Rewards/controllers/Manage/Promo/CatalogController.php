 ...
 */
class TBT_Rewards_Manage_Promo_CatalogController extends Mage_Adminhtml_Controller_Action
{
    ...
    {
        $this->loadLayout()
            ->_setActiveMenu('rewards/rules/catalog')
            ->_addBreadcrumb(Mage::helper('rewards')->__('Catalog Point Rules'), Mage::helper('rewards')->__('Catalog Point Rule'))
        ;
        return $this;
    }
    ...
    public function editAction($id = null)
    {
        ...
        $block = $this->getLayout()->createBlock('rewards/manage_promo_catalog_edit')
            ->setData('action', $this->getUrl('*/promo_catalog/save', array('type'=>$type)));
        ...
        $this
            ...
            ->_addContent($block)
            ->_addLeft($this->getLayout()->createBlock('rewards/manage_promo_catalog_edit_tabs'))
            ->renderLayout();
    ...
    public function saveAction()
    {
        if ($data = $this->getRequest()->getPost()) {
            ...
            try {
                ...
                if ($autoApply) {
                    $this->_forward('applyRules', 'manage_promo_catalog', 'rewards', array('type' => $type, 'id' => $model->getId()));
    ...
    public function applyRulesAction()
    {
        ...
        $this->_redirect('*/manage_promo_catalog/index', array('type'=>$type));
