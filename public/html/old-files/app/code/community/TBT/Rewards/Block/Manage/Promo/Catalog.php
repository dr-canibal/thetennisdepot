...
class TBT_Rewards_Block_Manage_Promo_Catalog extends Mage_Adminhtml_Block_Widget_Grid_Container
{
	protected $_blockGroup = 'rewards';
    public function __construct()
    {
        $this->_addButton('apply_rules', array(
            'label'     => Mage::helper('rewards')->__('Apply Rules'),
            'onclick'   => "location.href='".$this->getApplyRulesUrl()."'",
            'class'     => '',
        ));
    ...
    public function getApplyRulesUrl()
    {
        ...
        return $this->getUrl('*/*/applyRules', array('type'=>$typeId));
    }
