 ...
 */
class TBT_Rewards_Block_Manage_Catalog_Product_Edit_Tab_Redemption
...
//        $this->addExportType('*/*/exportXml', Mage::helper('customer')->__('XML'));
    ...
    protected function _prepareLayout() {
        ...
        $this->setChild('new_rRule',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData(array(
                    'label'     => Mage::helper('adminhtml')->__('New Redemption Rule'),
...
//						'url'       => array('base'=> 'rewards/manage_transfer/edit'),
    ...
    {
        return $this->getUrl(
        	'rewards/manage_catalog_product_edit/rRulesGrid', 
        	array(
