...
{	
    ...
    public function getDistributionReasons() {
        return array(
			self::REASON_CUSTOMER_DISTRIBUTION		=> Mage::helper('rewards')->__('Points Distribution'),
        );
    }

    public function getRedemptionReasons() {
        return array(
            self::REASON_CUSTOMER_REDEMPTION        => Mage::helper('rewards')->__('Points Redeemed on Order'),
        );
    }
    
    public function getOtherReasons() {
        return array(
            self::REASON_SYSTEM_ADJUSTMENT       => Mage::helper('rewards')->__('System Adjustment'),
            self::REASON_FROM_CUSTOMER           => Mage::helper('rewards')->__('Points Received From a Friend'),
            self::REASON_TO_CUSTOMER             => Mage::helper('rewards')->__('Points Given To a Friend'),
            self::REASON_SYSTEM_REVOKED          => Mage::helper('rewards')->__('Points Revoked'),
			self::REASON_ADMIN_ADJUSTMENT        => Mage::helper('rewards')->__('Administrative Adjustment'),
			self::REASON_UNSPECIFIED             => Mage::helper('rewards')->__('WARNING: UNSPECIFIED REASON'),
        );
    }
    ...
    public function getManualReasons() {
        return $this->getAvailReasons(self::REASON_ADMIN_ADJUSTMENT);
    }
