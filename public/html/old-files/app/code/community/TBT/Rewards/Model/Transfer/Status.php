...
{	
    ...
    public function getOptionArray()
    {
        return array(
			...
			self::STATUS_ON_HOLD		=> Mage::helper('rewards')->__('On Hold'),
			self::STATUS_PENDING		=> Mage::helper('rewards')->__('Pending'),
    ...
    public function getAvailableNextStatuses($current_status) {
        switch($current_status) {
            ...
            case self::STATUS_PENDING:
                return array(self::STATUS_PENDING, self::STATUS_CANCELLED, self::STATUS_APPROVED, 
                        self::STATUS_ON_HOLD);
    ...
    public function genSelectableStatuses() {
        return array(
            array('label'=>Mage::helper('rewards')->__('Approved'), 'value'=>self::STATUS_APPROVED),
            array('label'=>Mage::helper('rewards')->__('Cancelled') , 'value'=>self::STATUS_CANCELLED),
            array('label'=>Mage::helper('rewards')->__('On Hold'), 'value'=>self::STATUS_ON_HOLD),
            array('label'=>Mage::helper('rewards')->__('Pending'), 'value'=>self::STATUS_PENDING)
        );
    }
    
    public function canAdjustQty($current_status) {
        switch($current_status) {
            case self::STATUS_CANCELLED:    return false;
            case self::STATUS_APPROVED:     return false;
            case self::STATUS_ON_HOLD:      return true;
            case self::STATUS_PENDING:      return true;
            default:
                return true;
        }
    }
