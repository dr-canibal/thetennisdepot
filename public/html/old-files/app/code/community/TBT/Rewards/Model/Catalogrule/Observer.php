...
//		Mage::log('2');
		...
		if ( !($points = Mage::helper('rewards/transfer')->calculateCatalogPoints($apply_rule_id, $item, true)) ) {
			throw new Exception('The catalog redemption rule entitled '
						. $rule->getName()
...
//		Mage::log('7');
    ...
    protected function updateRulesHashOnProduct($product_id)
    {
