...
class TBT_Rewards_Block_Customer_Sidebar extends Mage_Core_Block_Template
{
	...
	public function getPointsSpending() {
		$str = $this->_getRewardsHelper()->emphasizeThePoints(
			$this->_getRewardsSess()->getTotalPointsSpendingAsString()
		);
		return $str;
	}
	...
	public function getPointsEarning() {
		$str = $this->_getRewardsHelper()->emphasizeThePoints(
			$this->_getRewardsSess()->getTotalPointsEarningAsString()
		);
		return $str;
	}
	...
	public function getCustomerPoints() {
		$str = $this->_getRewardsHelper()->emphasizeThePoints(
			$this->_getRewardsSess()->getSessionCustomer()->getPointsSummary()
		);
		return $str;
	}
	...
	public function getPointsRemaining() {
		$points_remain_str = $this->_getRewardsHelper()->emphasizeThePoints(
			$this->_getRewardsSess()->getTotalPointsRemainingAsString()
		);
