...
class TBT_Rewards_Manage_Promo_QuoteController extends Mage_Adminhtml_Controller_Action
{
    ...
    {
        $this->loadLayout()
            ->_setActiveMenu('rewards/rules/quote')
            ->_addBreadcrumb(Mage::helper('rewards')->__('Promotions'), Mage::helper('rewards')->__('Promotions'))
        ;
        return $this;
    }
    ...
    public function editAction()
    {
        ...
        $block = $this->getLayout()->createBlock('rewards/manage_promo_quote_edit')
        ...
        $this
            ->_addBreadcrumb($id ? Mage::helper('rewards')->__('Edit Rule') : Mage::helper('rewards')->__('New Rule'), $id ? Mage::helper('rewards')->__('Edit Rule') : Mage::helper('rewards')->__('New Rule'))
            ->_addContent($block)
            ->_addLeft($this->getLayout()->createBlock('rewards/manage_promo_quote_edit_tabs'))
            ->renderLayout();
    ...
    public function gridAction()
    {
        ...
        $this->getResponse()->setBody(
            $this->getLayout()->createBlock('rewards/manage_promo_quote_edit_tab_product')->toHtml()
        );
    }
