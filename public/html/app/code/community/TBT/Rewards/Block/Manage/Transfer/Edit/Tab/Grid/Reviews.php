...
//                array('shipping_firstname', 'shipping_lastname'));
        ...
        $this->setChild('clear_selections_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData(array(
                    ...
                    'onclick'   => 'clearGridSelections(\'review_id\')',
                ))
        );
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('assigned_review', array(
            'header_css_class' => 'a-center',
            'header'    => Mage::helper('adminhtml')->__('Origin'),
            'type'      => 'radio',
            'html_name' => 'review_id',
            'values'    => $this->_getSelectedReviews(),
            'align'     => 'center',
            'index'     => 'review_id',
        ...
        if (!Mage::app()->isSingleStoreMode()) {
            $this->addColumn('review_store_id', array(
                'header'    => Mage::helper('review')->__('Reviewed in (store)'),
                'index'     => 'store_id',
                'type'      => 'store',
                'store_view'=> true,
        ...
        $this->addColumn('created_at', array(
            'header' => Mage::helper('review')->__('Reviewed On'),
            'index' => 'created_at',
            'type' => 'datetime',
            'width' => '100px',
        ));
        ...
        $this->addColumn('review_status_id', array(
            'header' => Mage::helper('review')->__('Status'),
            'index' => 'status_id',
            //'type'  => 'options',
            /**/'type'  => 'int',
            'width' => '70px',
            //'options' => Mage::getSingleton('review/review')->getStatusCollection(),
        ));
