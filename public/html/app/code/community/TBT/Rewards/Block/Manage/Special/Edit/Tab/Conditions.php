...
class TBT_Rewards_Block_Manage_Special_Edit_Tab_Conditions extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('points_conditions', 'select', array(
            'label'     => Mage::helper('salesrule')->__('Customer...'),
        ...
        $fieldset->addField('customer_group_ids', 'multiselect', array(
            ...
            'label'     => Mage::helper('salesrule')->__('Customer Group Is... '),
            'title'     => Mage::helper('salesrule')->__('Customer Group Is... '),
            'required'  => true,
        ...
        $fieldset->addField('from_date', 'date', array(
            'name'   => 'from_date',
            'label'  => Mage::helper('salesrule')->__('Date is After...'),
            'title'  => Mage::helper('salesrule')->__('Date is Before...'),
        ...
        $fieldset->addField('to_date', 'date', array(
            'name'   => 'to_date',
            'label'  => Mage::helper('salesrule')->__('Date is Before: '),
            'title'  => Mage::helper('salesrule')->__('Date is Before: '),
            'image'  => $this->getSkinUrl('images/grid-cal.gif'),
            'input_format' => Varien_Date::DATE_INTERNAL_FORMAT,
            'format'       => $dateFormatIso,
