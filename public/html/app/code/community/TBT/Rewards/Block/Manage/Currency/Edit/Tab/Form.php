...
class TBT_Rewards_Block_Manage_Currency_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
	protected function _prepareForm()
	{
        ...
        $fieldset->addField('active', 'select', array(
            'label'     => Mage::helper('rewards')->__('Active'),
            'title'     => Mage::helper('rewards')->__('Active'),
            'name'      => 'active',
            'options'    => Mage::helper('rewards/currency')->getActiveOptions(),
        ));

        $fieldset->addField('caption', 'text', array(
            'name' => 'caption',
//            'required' => true,      //@nelkaake no longer required as of Sweet Tooth 1.3 (2/17/2010 7:00:09 AM)
...
//        ));
        ...
        $fieldset->addField('value', 'text', array(
            ...
            'label' => Mage::helper('rewards')->__('Currency Value'),
        ));
