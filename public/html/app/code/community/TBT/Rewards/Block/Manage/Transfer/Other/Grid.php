...
/**
 * Manage Transfer Other Grid
 *
 * @category   TBT
 * @package    TBT_Rewards
 * @author     WDCA Sweet Tooth Team <contact@wdca.ca>
 */
class TBT_Rewards_Block_Manage_Transfer_Other_Grid extends TBT_Rewards_Block_Manage_Transfer_Grid
{
	...
	protected function _prepareCollection()
	{
		...
		$this->collection->selectOnlyOtherTransfers();
	...
	protected function _prepareColumns()
	{
        ...
        */
		...
		$this->addColumn('fullcustomername', array(
		  'header'    => Mage::helper('rewards')->__('Customer'),
		  'align'     =>'left',
		  'width'     => '80px',
		  'index'     => 'fullcustomername',
		  'filter_index'	=> "CONCAT(customer_firstname_table.value, ' ', customer_lastname_table.value)"
		));		
		
		

        $reasons = Mage::getSingleton('rewards/transfer_reason')->getOtherReasons();
        if(count($reasons) > 1) {
