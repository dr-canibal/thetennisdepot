...
/**
 * Points String Display
 * Used globally and will replace all uses of Mage::helper('rewards')->getPointsString();
 *
 * @category   TBT
 * @package    TBT_Rewards
...
class TBT_Rewards_Block_Points extends Mage_Core_Block_Template
{
    ...
    {
    	$fileName = str_replace('adminhtml', 'frontend', $fileName);
    	$fileName = str_replace('base'.DS, 'default'.DS, $fileName);
