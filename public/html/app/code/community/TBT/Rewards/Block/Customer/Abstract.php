...
/**
 * Customer rewards section abstract block
 *
 * @category   TBT
 * @package    TBT_Rewards
 * @author     WDCA Sweet Tooth Team <contact@wdca.ca>
 */
abstract class TBT_Rewards_Block_Customer_Abstract extends Mage_Core_Block_Template {
    ...
    public function getPointsOptimizer($product) {
        ...
        $predict_points_block->setProduct($product);
