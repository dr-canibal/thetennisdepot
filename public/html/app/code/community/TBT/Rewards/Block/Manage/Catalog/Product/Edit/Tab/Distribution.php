...
//        $this->addExportType('*/*/exportXml', Mage::helper('customer')->__('XML'));
    ...
    protected function _prepareLayout() {
    	$url = $this->getUrl('rewardsadmin/manage_promo_catalog/new', array( 
    					'type'=>1
    	));
...
//						'url'       => array('base'=> 'rewardsadmin/manage_transfer/edit'),
						'url' => array('base'=> 'rewardsadmin/manage_promo_catalog/'.
									'edit/type/1'),
						'field'     => 'id'
					)
				),
    ...
    {
        return $this->getUrl(
        	'rewardsadmin/manage_catalog_product_edit/dRulesGrid', 
        	array(
