...
class TBT_Rewards_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    const XML_PATH_ENABLED = 'rewards/general/active';
    
    //@nelkaake Added on Thursday May 27, 2010: Sweet Tooth level logging
    const LOG_NOTICE = false;
    ...
    /**
     * True if the Magento version currently being run is 1.2.x.x
     *
     * @return boolean
     */
    ...
    /**
     * True if the Magento version currently being run is 1.3.1.x 
     *
     * @return boolean
     */
    public function isMageVersion131() {
    	$version_sections = explode('.', Mage::getVersion());
    	$isMajor1 = (int)$version_sections[0] === 1;
    	$isMinor3 = (int)$version_sections[1] === 3;
    	$isMicro1 = (int)$version_sections[2] === 1;
    	return $isMajor1 && $isMinor3 && $isMicro1;
    }

    /**
     * True if the Magento version currently being run is 1.4.x.x
     *
     * @return boolean
     */
    public function isMageVersion14() {
    	$version_sections = explode('.', Mage::getVersion());
    	$isMajor1 = (int)$version_sections[0] === 1;
    	$isMinor4 = (int)$version_sections[1] === 4;
    	return $isMajor1 && $isMinor4;
    }
    ...
    public function notice($msg) {
        if(self::LOG_NOTICE) $this->log($msg);
    }
}
