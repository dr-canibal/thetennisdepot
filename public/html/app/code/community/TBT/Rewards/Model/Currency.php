 ...
 */
class TBT_Rewards_Model_Currency extends Mage_Core_Model_Abstract
        implements TBT_Rewards_Model_Migration_Importable
{
    ...
    public function _afterSave() {
        ...
        if($this->getOrderId()) {
            $ref = Mage::getModel('rewards/transfer_reference')
                ->loadByTransferAndReference($this->getId(), $this->getOrderId());
    ...
    public function saveWithId()
    {
        ...
        if(!$exists) {
            ...
            $write->update(
                ...
                array( $this->_getResource()->getIdFieldName() => $real_id ),
