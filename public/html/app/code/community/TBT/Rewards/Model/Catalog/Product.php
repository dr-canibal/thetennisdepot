...
class TBT_Rewards_Model_Catalog_Product extends Mage_Catalog_Model_Product
{
	...
	public function getEarnablePoints() {
	    if(!$this->hasData("earnable_points")) $this->setData("earnable_points", $this->getDistriRewards());
        return $this->getData("earnable_points");
	}
	//@nelkaake 3/10/2010 4:31:06 PM : highly optimizes the fetching method.
	public function getCatalogRuleCollection() {
	    if(!$this->hasData("all_catalog_rules")) $this->setData("all_catalog_rules", $this->getDistriRewards());
        return $this->getData("earnable_points");
	}
     ...
     */
    public function getCatalogRuleIds($wId = null, $gId = null) {
    	return $this->getCatalogRewardsRuleIdsForProduct($wId, $gId);    	
    }
     ...
     * @return  array(int)                          : An array of rule ID's that are associated with the item
     */
    public function getCatalogRewardsRuleIdsForProduct($wId = null, $gId = null)
    {
