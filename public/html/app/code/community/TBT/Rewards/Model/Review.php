    ...
    protected function approvePendingTransfers(){
    	foreach($this->getAssociatedTransfers() as $transfer){
    		if($transfer->getStatus() == TBT_Rewards_Model_Transfer_Status::STATUS_PENDING){
    			...
    			$transfer->setStatus(TBT_Rewards_Model_Transfer_Status::STATUS_PENDING,
    ...
    private function ifNewReview(){
        ...
        foreach($ruleCollection as $rule){
	        ...
	        if ($is_transfer_successful) {
                ...
                Mage::getSingleton('core/session')->addSuccess(Mage::helper('rewards')->__('You will receive %s upon approval of this review',
