 ...
 */
class TBT_Rewards_Model_Migration_Delete extends Varien_Object
{

    public function deleteOnlyRules() {
            $this->deleteAllCatalogruleRuleData();
            $this->deleteAllSalesruleRuleData();
            $this->deleteSpecialRuleData();
            return $this;
    }
    ...
    public function deleteCollection($collection, $model_key=false) {
