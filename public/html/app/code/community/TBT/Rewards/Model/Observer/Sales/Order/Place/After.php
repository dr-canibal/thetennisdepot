 ...
 */
class TBT_Rewards_Model_Observer_Sales_Order_Place_After
    ...
    */
    public function prepareCartPointsTransfers($observer)
    {
        ...
        try {
		    ...
		    //        Mage::helper('rewards')->notice("Checkout method is REGISTER to added customer listener...");
