...
class TBT_RewardsReferral_Model_Observer_Refer extends Varien_Object {
	...
	public function recordPointsUponRegistration($observer){
        ...
        try {
            if (!Mage::getModel('rewardsref/referral_signup')->hasReferralPoints()) return $this;
    ...
    {
        try {
            if (!Mage::getModel('rewardsref/referral_firstorder')->hasReferralPoints()) return $this;
    ...
    {
        try {
            if (!Mage::getModel('rewardsref/referral_order')->hasReferralPoints()) return $this;
            //$order = $observer->getEvent()->getInvoice()->getOrder();
