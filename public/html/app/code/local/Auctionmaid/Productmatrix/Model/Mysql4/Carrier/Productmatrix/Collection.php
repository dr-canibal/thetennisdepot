 ...
 *
 * Shipping MatrixRates collection
 *
 * @category   Auctionmaid
 * @package    Auctionmaid_Priceweight
...
*/
class Auctionmaid_Productmatrix_Model_Mysql4_Carrier_Productmatrix_Collection extends Varien_Data_Collection_Db
{
