...
class Evolved_Like_Model_System_Config_Source_Layout
{

    public function toOptionArray()
    {
        return array(
            array('value'=>Mage::helper('evlike')->__('standard'), 'label'=>Mage::helper('evlike')->__('standard')),
            array('value'=>Mage::helper('evlike')->__('button_count'), 'label'=>Mage::helper('evlike')->__('button_count')),
        );
    }
