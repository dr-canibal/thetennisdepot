<?php 
    ...
    |
    | Copyright 2009-2010 Interapptive, Inc.  All rights reserved.
    | http://www.interapptive.com/
    |
    |
     */
    define('REQUIRE_SECURE', true);
    $moduleVersion = "3.0.8.0";
    $schemaVersion = "1.0.0";
	...
	function MagentoVersionGreaterOrEqualTo($targetVersion)
	{
		...
		$currentParts = split('[.]', $mageVersion);
		$targetParts = split('[.]', $targetVersion);
