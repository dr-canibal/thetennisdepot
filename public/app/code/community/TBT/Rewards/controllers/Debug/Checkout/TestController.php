...
class TBT_Rewards_Debug_Checkout_TestController extends Mage_Core_Controller_Front_Action
{
    ...
    public function printSalesruleDistriAction() {
    	echo "<html><body>";
    	$this->printSalesruleDistri();
    	echo "</body></html>";
    }
    
    protected function printSalesruleDistri() {
    	echo "<PRE>";
    	
    	print_r($this->_getSess()->updateShoppingCartPoints());
