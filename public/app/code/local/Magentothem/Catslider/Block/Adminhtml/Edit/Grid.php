<?php
class Magentothem_Catslider_Block_Adminhtml_Edit_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        ...
        $collection = Mage::getModel('catalog/product')->getCollection()
                ...
                ->addAttributeToSelect('mage_featured_product')
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('visibility', array(
            ...
            'index' => 'visibility',
            'filter'    => false,
            'renderer'  => 'catslider/adminhtml_edit_renderer_visibility',
        ));
    ...
    protected function _getSelectedProducts($json=false) {
        ...
        $_prod = Mage::getModel('catalog/product')->getCollection()
                ->joinAttribute('mage_featured_product', 'catalog_product/mage_featured_product', 'entity_id', null, 'left', $store->getId())
                ->addAttributeToFilter('mage_featured_product', '1');
