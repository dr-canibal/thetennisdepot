 ...
 */class AW_FBIntegrator_Model_Facebook_Api{
  /**
   * Version.
   */
  const VERSION = '2.1.2';
   ...
   * @throws AW_FBIntegrator_Model_Facebook_Exception
   */
  protected function _restserver($params) {
    ...
    if (is_array($result) && isset($result['error_code'])) {
      throw new AW_FBIntegrator_Model_Facebook_Exception($result);
    }
    return $result;
  }
  ...
  protected function _graph($path, $method='GET', $params=array()) {
    ...
    if (is_array($result) && isset($result['error'])) {
      $e = new AW_FBIntegrator_Model_Facebook_Exception($result);
      switch ($e->getType()) {
  ...
  protected function makeRequest($url, $params, $ch=null) {
    ...
    $result = curl_exec($ch);
    if ($result === false) {
      $e = new AW_FBIntegrator_Model_Facebook_Exception(array(
