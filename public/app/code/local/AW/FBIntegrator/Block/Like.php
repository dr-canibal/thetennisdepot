...
class AW_Fbintegrator_Block_Like extends Block{
    ...
    public function canShow(){
        ...
        if($helper->extEnabled() && $helper->checkApp() && $helper->likeEnabled()){
            if(!($this->getNameInLayout() == 'fbintegrator.like-button-on-product-page' && $helper->likePosition() != AW_FBIntegrator_Model_System_Config_Backend_Source_Position::PRODUCT_PAGE_POSITION))
                return true;
        }
        else
            return false;
